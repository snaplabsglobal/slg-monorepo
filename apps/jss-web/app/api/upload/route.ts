...
export async function POST(request: NextRequest) {
  try {
    ...
    const folder = formData.get('folder') as string || 'site-photos'  // Default folder for JSS
    const transactionId = formData.get('transactionId') as string
    const projectId = formData.get('projectId') as string  // JSS specific: project ID
    ...
    // Generate file path (use projectId if available, otherwise transactionId)
