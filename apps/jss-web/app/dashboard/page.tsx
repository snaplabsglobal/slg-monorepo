    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-primary">JobSite Snap</h1>
            <p className="text-sm text-gray-600">Job Site Timecard Management</p>
          </div>
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Digitize timecards and manage worker attendance on the job site
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-primary">📱 Clock In/Out</CardTitle>
              <CardDescription>
                Record work hours
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                Clock in and out to track your work hours on the job site
              </p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-primary">⏱️ Timecards</CardTitle>
              <CardDescription>
                View and manage timecards
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                Browse all your timecard entries and work history
              </p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-primary">👷 Worker Management</CardTitle>
              <CardDescription>
                Manage workers and teams
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                Add, edit, and manage workers on your job sites
              </p>
              <Button variant="outline" className="w-full">
                Manage Workers
              </Button>
