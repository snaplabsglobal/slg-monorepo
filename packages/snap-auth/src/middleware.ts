...
// Use any for NextRequest to avoid version conflicts
// The actual type will be resolved by the consuming app
 ...
 * 
 * For SSO: Configure NEXT_PUBLIC_COOKIE_DOMAIN to enable cross-subdomain sharing
 */
