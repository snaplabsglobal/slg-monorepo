...
COMMENT ON COLUMN receipts.gemini_response IS 'Full JSON response from Gemini API for debugging and reprocessing';
COMMENT ON COLUMN receipts.confidence_score IS 'AI confidence score (0.00 to 1.00)';
